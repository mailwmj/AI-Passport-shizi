...
run_static_checks() {
    ...
    "${CC:-cc}" -std=c11 -Wall -Wextra -Werror -Imain -Imain/hanzi \
        tests/test_hanzi_deck.c main/hanzi/hanzi_deck.c main/hanzi/siwu_hanzi_table.c \
        -o "${test_dir}/test_hanzi_deck"
    "${test_dir}/test_hanzi_deck"
    "${CC:-cc}" -std=c11 -Wall -Wextra -Werror -Imain \
...
run_firmware_checks() (
    ...
    idf.py -B "${validation_build_dir}" merge-bin \
        -o "${validation_build_dir}/Xiaoer-Shizi-full.bin"
    ...
    install -m 0644 \
        "${validation_build_dir}/Xiaoer-Shizi-full.bin" \
        "${repo_root}/build/Xiaoer-Shizi-full.bin"
