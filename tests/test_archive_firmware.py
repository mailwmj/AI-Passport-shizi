...
class FirmwareArchiveTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.build.mkdir()
        self.app_name = "Xiaoer-Shizi.bin"
        self.elf_name = "Xiaoer-Shizi.elf"
        self.map_name = "Xiaoer-Shizi.map"
        self.full_name = "Xiaoer-Shizi-full.bin"
        self.offsets = {
        ...
        app[80:112] = b"Xiaoer-Shizi".ljust(32, b"\x00")
    ...
    def test_round_trip_records_only_real_artifacts_and_descriptor_metadata(self) -> None:
        ...
        self.assertEqual(manifest["app_descriptor"]["project_name"], "Xiaoer-Shizi")
    ...
    def test_unsafe_flash_args_are_rejected_without_execution(self) -> None:
        ...
        for line in (
            ...
            "0x1000 Xiaoer-Shizi.bin", "-1 outside.bin", "0x800000 outside.bin",
